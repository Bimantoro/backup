<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/liputan/add_liputan')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_liputan","bSortable":false },
			{ "mDataProp": "judul"},
			{ "mDataProp": "foto"},
			{ "mDataProp": "deskripsi_foto"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_liputan'];  
		var url_edit = "<?php echo site_url('admin/liputan/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/liputan/delete')?>/"+id;
