...
class Sidemenu extends CI_Controller {
   ...
   public function index($uri=0){
	...
	function menu_json(){
        ...
        $this->datatables->select(" m1.id_menu as id_menu, m1.kode_unit as kode_unit, m1.nama_menu as nama_menu, m1.url as url, m1.kode_bahasa as kode_bahasa, m1.menu_order as order")
        ->add_column('action', '$1','m1.id_menu')
        ->from("side_menu as m1")->where('kode_unit', $kode_unit);
