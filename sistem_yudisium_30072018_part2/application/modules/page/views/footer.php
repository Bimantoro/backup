					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="contact-details">
								<h4>Contact Us</h4>
								<ul class="contact">
									<li><p><i class="fa fa-map-marker"></i> <?php echo 'Jl. Marsda Adisucipto Yogyakarta';?></p></li>
									<li><p><i class="fa fa-phone"></i> <strong>Phone:</strong> <?php echo  '+62-274-512474, +62-274-589621';?></p></li>
									<li><p><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:mail@example.com"> <?php echo 'humas@uin-suka.ac.id';?></a></p></li>
								</ul>
							</div>
						</div>
						<div class="col-md-3">
		...
		<link href="<?php echo base_url()?>/asset/colorpicker/dist/css/bootstrap-colorpicker.min.css" rel="stylesheet">
		
		<script src="//code.jquery.com/jquery-3.1.1.min.js"></script>

		<!-- <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js"></script> -->

		<!-- <script src="<?php echo base_url()?>asset/token-input/src/jquery.tokeninput.js"></script>
		<link href="<?php echo base_url()?>/asset/token-input/styles/token-input.css" rel="stylesheet"> -->
		...
		<script src="<?php echo base_url()?>asset/colorpicker/dist/js/bootstrap-colorpicker.js"></script>
