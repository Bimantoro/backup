<div class="article-content">	
	...
	<h2 class="mb-xl heading-primary">Dosen</h2>
		...
		<h4 class="mt-xl heading-primary"><a class='item' href="<?php echo site_url('page/detil_dosen/'.$d['KD_DOSEN'].'/mengajar')?>" title="Pengalaman Mengajar" target='_self'><u>Pengalaman Mengajar</u></a></h4>
		<?php 
		...
		<?php	}else{ ?>
			...
			foreach ($amk as $m){ ?>
				...
				<div class="clear20"></div>
		<?php } }?>
		<h4 class="mt-xl heading-primary"><a class='item' href="<?php echo site_url('page/detil_dosen/'.$d['KD_DOSEN'].'/penelitian')?>" title="Pengalaman Penelitian" target='_self'><u>Pengalaman Penelitian</u></a></h4>
		...
		<h4 class="mt-xl heading-primary"><a class='item' href="<?php echo site_url('page/detil_dosen/'.$d['KD_DOSEN'].'/pengabdian')?>" title="Pengalaman Pengabdian Masyarakat" target='_self'><u>Pengalaman Pengabdian Masyarakat</u></a></h4>
		...
		<h4 class="mt-xl heading-primary"><a class='item' href="<?php echo site_url('page/detil_dosen/'.$d['KD_DOSEN'].'/tugas')?>" title="Pengalaman Tugas Penunjang" target='_self'><u>Pengalaman Tugas Penunjang</u></a></h4>
