...
<?php $lang=$this->page_lib->lang(); ?>									
		...
		<h2 class="mb-xl heading-primary"><?php echo ucwords(dict('Jadwal Kuliah', $lang)) ?> <?php echo $arr_smt[$smt] ?> <?php echo ucwords(dict('Tahun Akademik', $lang)) ?> <?php echo $tad?></h2>		
			...
			<form class="form-horizontal" role="form" id="form" method="post" action="">
			  <div class="form-group">
				...
				<div class="form-group">
					<div class="col-xs-12 col-sm-3 col-md-2"><strong><?php echo ucwords(dict('Semester', $lang)) ?></strong></div>
					...
					<div class="col-xs-12 col-sm-2 col-md-2">      	
						<button type="submit" class="btn btn-primary"><?php echo ucwords(dict('Lihat Jadwal', $lang)) ?></button>
					</div>
				</div>
			</form>	
			<div class="clear20"></div>	
		...
		<div class="col-sm-3 col-md-3"><strong><?php echo ucwords(dict('Hari', $lang)) ?> : <?php echo ucwords(dict($arh[$hari], $lang))?></strong></div>
