...
<?php $lang=$this->page_lib->lang(); ?>
	...
	<?php $i=0;?>
		<table class="table table-bordered table-hover table-condensed">
			<thead>
				<tr><th  style="text-align: center;"><?php echo ucwords(dict('No', $lang)) ?></th><th  style="text-align: center;"><?php echo ucwords(dict('NIP', $lang)) ?></th><th  style="text-align: center;"><?php echo ucwords(dict('Nama', $lang)) ?></th><th  style="text-align: center;"><?php echo ucwords(dict('Status', $lang)) ?></th></tr>
			</thead>
			<tbody>	
			<?php 
			foreach ($dosen as $j){ ?>
