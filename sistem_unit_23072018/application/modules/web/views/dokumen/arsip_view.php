...
<div  class="article-content">
	<h2 class="mb-xl heading-primary"><?php echo ucfirst(dict('Dokumen', $lang)) ?></h2>	
		...
		<?php $i=0;?>
			...
			<thead>
				<tr class="info"><th style="text-align:center;"><?php echo ucwords(dict('No', $lang)) ?></th><th style="text-align:center;"><?php echo ucwords(dict('Nama Dokumen', $lang)) ?></th><th style="text-align:center;"><?php echo ucfirst(dict('Unduhan', $lang)) ?></th></tr>
			</thead>
			<tbody>
