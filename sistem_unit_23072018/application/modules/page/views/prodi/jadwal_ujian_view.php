<div  class="article-content">
	...
	<div class="article-title">Jadwal Ujian <?php echo $arr_smt[$smt] ?> Tahun Akademik <?php echo $tad?></div>
...
<form class="form-horizontal" role="form" id="form" method="post" action="">
  <div class="form-group">
	...
	<div class="form-group">
		<label for="ju" class="col-sm-3 control-label">Jenis Ujian </label>
		<div class="col-sm-6">
	...
	if(isset($arj) and $arj!=null){
		foreach($arj as $hari=>$jadwal){?>
			<h5 style="margin-bottom:5px; color: rgb(164, 136, 74);"><?php echo nama_hari($hari).', '.tanggal_indonesia($hari); ?></h5>
