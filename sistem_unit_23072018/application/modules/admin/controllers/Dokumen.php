...
class Dokumen extends CI_Controller {
   ...
   public function detail($id=0){
	...
	function menu_json(){
        ...
        $this->datatables->select("m1.id_dokumen id_dokumen,m1.nama_dokumen nama_dokumen,m1.tahun tahun,concat(substring(m1.nama_file,1,30),'...') as nama_file, m1.tgl_posting tgl_posting")
	...
	function add_dokumen(){
		if($_POST==null){
			...
			if ($_FILES['nama_file']['size']==0 || $_FILES['nama_file']['size']>=2000000) {
