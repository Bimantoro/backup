...
public $data 	= 	array();
   ...
   function menu_json(){
	   $kode_unit = $this->session->userdata('kode_unit');
        $this->datatables->select("m1.id_berita id_berita,m1.judul judul,m1.isi isi,concat(substring(m1.ringkasan,1, 30),'...') as ringkasan,concat(substring(m1.foto,1, 25),'...') as foto, m1.tgl_posting tgl_posting")
