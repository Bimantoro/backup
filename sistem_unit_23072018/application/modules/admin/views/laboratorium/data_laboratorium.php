<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/main/add_laboratorium')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
<table class="datatable table table-striped table-bordered" id="datatable">
<thead>
  <tr>
	<th width="5%">No</th>
	<th width="35%">Nama Laboratorium</th>
	<th width="30">Foto</th>
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_lab","bSortable":false },
			{ "mDataProp": "nama_lab"},
			{ "mDataProp": "foto"},
			/* { "mDataProp": "deskripsi" }, */
	...
	function setURL(oObj){
		var id = oObj.aData['id_lab'];  
		var name = oObj.aData['nama_lab'];  
		name=name.toLowerCase().replace(' ','-');
		var url_data = "page/laboratorium/"+id+"/"+name;
		return url_data;
	}
	...
	function getAction(oObj){
		var id = oObj.aData['id_lab'];  
		var url_edit = "<?php echo site_url('admin/main/edit_laboratorium')?>/"+id;
		var url_delete = "<?php echo site_url('admin/main/delete_laboratorium')?>/"+id;
