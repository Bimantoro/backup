<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/kamus/add_kamus')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "kata","bSortable":false },
			{ "mDataProp": "kata"},
			{ "mDataProp": "kode"},
			{ "mDataProp": "terjemahan"},
	...
	function getAction(oObj){
		...
		var url_edit = "<?php echo site_url('admin/kamus/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/kamus/delete')?>/"+id;
