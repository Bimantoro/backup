...
<?php }else{ ?>
	...
	<div>
		<div class="container">
			...
			<form action="<?php echo base_url(); ?>skpi/skpi_prodi/verifikasi_data_prestasi" method="POST">
			<table class="table table-bordered">
				...
				<?php }else{ ?>
					...
					<tr>
						...
						<td align="center"><?php echo $key['THN_BERI']; ?></td>
						<td><?php echo $key['KETERANGAN']; ?></td>
						<td style="width: 60px; text-align: center;"><?php echo anchor('skpi/skpi_prodi/sertifikat_kegiatan/'.$key['ID_RIWAYAT'].'/prestasi', '<i class="icon-eye-open"></i> Lihat', array('class' => 'btn btn-mini')); ?></td>
			...
			<table class="table table-bordered">
				...
				<?php }else{ ?>
					...
					<tr>
						...
						<td align="center"><?php echo $key['JABATAN']; ?></td>
						<td align="center"><?php echo $key['LAMA']; ?></td>
						<td align="center"><?php echo $key['THN_MASUK']; ?></td>
						<td style="width: 60px; text-align: center;"><?php echo anchor('skpi/skpi_prodi/sertifikat_kegiatan/'.$key['ID_RIWAYAT'].'/organisasi', '<i class="icon-eye-open"></i> Lihat', array('class' => 'btn btn-mini')); ?></td>
					...
					<?php }else{ ?>
						...
						<?php foreach($dpm_sertifikasi as $key){ ?>
							<tr>
								...
								<td><?php echo $key['KETERANGAN']; ?></td>
								<td style="width: 60px; text-align: center;"><?php echo anchor('skpi/skpi_prodi/sertifikat_kegiatan/'.$key['ID_RIWAYAT'].'/sertifikasi', '<i class="icon-eye-open"></i> Lihat', array('class' => 'btn btn-mini')); ?></td>
					...
					<?php }else{ ?>
						...
						<?php foreach($dpm_magang as $key){ ?>
							<tr>
								...
								<td><?php echo $key['NM_PENY_KEGIATAN']; ?></td>
								<td><?php echo $key['KETERANGAN']; ?></td>
								<td style="width: 60px; text-align: center;"><?php echo anchor('skpi/skpi_prodi/sertifikat_kegiatan/'.$key['ID_RIWAYAT'].'/magang', '<i class="icon-eye-open"></i> Lihat', array('class' => 'btn btn-mini')); ?></td>
					...
					<?php }else{ ?>
						...
						<?php foreach($dpm_karakter as $key){ ?>
							<tr>
								...
								<td><?php echo $key['NM_PENY_KEGIATAN']; ?></td>
								<td><?php echo $key['KETERANGAN']; ?></td>
								<td style="width: 60px; text-align: center;"><?php echo anchor('skpi/skpi_prodi/sertifikat_kegiatan/'.$key['ID_RIWAYAT'].'/kegiatan', '<i class="icon-eye-open"></i>Lihat', array('class' => 'btn btn-mini')); ?></td>
		...
		<div>
			...
			<table class="table">
				<tr>
					...
					<td align="right"><?php echo anchor('skpi/skpi_prodi/verifikasi_penulisan/', 'Selanjutnya', array('class' => 'btn-uin btn btn-inverse btn btn-small')); ?></td>
				</tr>
			</table>
		</div>
	</div>
