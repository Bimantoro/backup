...
<body>
	...
	<form class="form-inline" action="<?php echo base_url(); ?>skpi/skpi_prodi/verifikasi_data_mhs" method="POST">
	...
	<?php if($status){ ?>
		...
		<div>
			<table class="table">
				<tr><td align="right"><?php echo anchor('skpi/skpi_prodi/verifikasi_data_cp', 'Selanjutnya', array('class' => 'btn-uin btn btn-inverse btn btn-small')); ?></td></tr>
			</table>
		</div>
