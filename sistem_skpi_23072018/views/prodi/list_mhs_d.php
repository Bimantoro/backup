...
<?php } ?>
<form class="form-inline" action="<?php echo base_url(); ?>skpi/skpi_prodi/list_mhs" method="POST">
...
<?php }else{ ?>
<form action="<?php echo base_url(); ?>skpi/skpi_prodi/verifikasi_penulisan" method="POST">
<?php } ?>
	...
	foreach ($mhs as $key) { ?>
		<tr>
			...
			<?php if($key['STATUS']){ ?>
				...
				<td align="center">
					<!-- <?php $nim = $key['NIM']; ?>
					<?php echo anchor('skpi/skpi_prodi/cetak_skpi/'.$nim, 'Cetak', array('class' => 'btn-uin btn btn-inverse btn btn-small' , 'target' => '_blank')); ?> -->
					-
				</td>
			<?php }else{ ?>
				<td class="tac" align="center">
