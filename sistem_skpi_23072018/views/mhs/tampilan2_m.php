...
<!-- 	<div>
	...
	<div>
		<h2>Alur Pendaftaran Verifikasi <?php echo $string_skpi[0]; ?></h2>
		...
		<div class="bs-callout bs-callout-on-progress">
			...
			<br>
			<p>Jika dirasa data diatas sudah benar, maka silahkan lanjutkan ke proses pendaftaran verifikasi <?php echo $string_skpi[0]; ?> dan dengan dilakukannya pendaftaran verifikasi <?php echo $string_skpi[0]; ?> data tersebut diatas sudah tidak dapat diperbaharui.</p>
			<br>
			<p>
				<div class="jumbotron" style="background-color: white; border-radius: 5px; padding: 10px;">
					<table class="table table-bordered" style="border: 1px solid white; margin: 0px;">
						<tr>
							...
							<td style="border: 1px;"> <b>Ya saya setuju</b> melanjutkan proses pendaftaran verifikasi <?php echo $string_skpi[0]; ?> dan tidak akan melakukan perubahan data tersebut diatas. </td>
						</tr>
					</table>
				</div>
			</p>
	...
	<div>
		...
		<table style="margin: 5px 0 30px 0;">
			<tbody>
				...
				<td style="">&nbsp; : Informasi Data <?php echo $string_skpi[0]; ?></td>
				</tr>
			</tbody>
		</table>
	</div>
