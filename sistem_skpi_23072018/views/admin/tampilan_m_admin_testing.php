<?php
	...
	//echo '<pre>'; print_r($SYARAT_DAFTAR); echo '</pre>';
?> 
...
<!-- 	<div>
	...
	<div>
		...
		<br>
		<ol class="progtrckr" data-progtrckr-steps="2">
			<li class="progtrckr-done number1">Daftar Verifikasi SKPI</li><!--
			--><li class="progtrckr-onprogress number2">Verifikasi SKPI</li>
		</ol>
		<?php }else{ ?>
		<ol class="progtrckr" data-progtrckr-steps="2">
			<li class="progtrckr-done number1">Daftar Verifikasi SKPI</li><!--
			--><li class="progtrckr-done number2">Verifikasi SKPI</li>
		</ol>
		<?php } ?>
					...
					<?php for($j=0; $j < $jml_data; $j++){ ?>
						<?php if($j==0){ ?>
							<tr>
								...
								<td rowspan="<?php echo $jml_data; ?>"><?php echo $KEGIATAN[1][$i]['idn']; ?> <hr> <a href="<?php echo $LINK_DPM[$i]; ?>" ><i style="color: #1a0dab;">Perbaiki Data</i></a></td>
								<td><?php echo ($KEGIATAN[2][$i][$j]['IDN']=='')?'-':$KEGIATAN[2][$i][$j]['IDN']; ?></td>
								<td><i><?php echo ($KEGIATAN[2][$i][$j]['EN']=='')?'-':$KEGIATAN[2][$i][$j]['EN']; ?></i></td>
								<td rowspan="<?php echo $jml_data; ?>" style="vertical-align: middle;">
	...
	<div>
		...
		<table style="margin: 5px 0 30px 0;">
			<tbody>
				...
				<td style="">&nbsp; : Syarat <b>BELUM</b> lengkap. Silahkan lengkapi penulisan data kegiatan atau hubungi petugas</td>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<?php }else{ ?>
		<div>
			<h2>Alur Pendaftaran SKPI</h2>
			<ol class="progtrckr" data-progtrckr-steps="2">
				<li class="progtrckr-todo number1">Daftar Verifikasi SKPI</li><!--
				--><li class="progtrckr-todo number2">Verifikasi SKPI</li>
			</ol>

			<div class="bs-callout bs-callout-todo">
					<p>	Mohon Maaf <b><?php echo $NAMA; ?></b>, Anda belum dapat melakukan Pendaftaran Verifikasi Surat Ket. Pendamping Ijazah, karena Syarat pendaftaran verifikasi Surat Ket. Pendamping Ijazah belum ada untuk Program Studi anda. Silahkan menghubungi petugas</p>
			</div>
		</div>
	<?php } ?>
	<?php }else{ ?>
		<div>
			...
			<div class="bs-callout bs-callout-on-progress">
					<p>	Mohon Maaf <b><?php echo $NAMA; ?></b>, pendaftaran verifikasi Surat Ket. Pendamping Ijazah <b>DIBATALKAN</b> dengan keterangan sebagai berikut : </p>
					<br>
					<p>
					...
					<br>
					<p>Silahkan tekan tombol berikut untuk melakukan daftar ulang verifikasi Surat Ket. Pendamping Ijazah</p>
					<br>
