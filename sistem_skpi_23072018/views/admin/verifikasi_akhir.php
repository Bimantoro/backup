...
<body>
	...
	<div class="container">
		<div style="padding: 2%;">
			<div style="border-radius: 5px; background-color: #d0e9c6;">
				...
				<form action="<?php echo base_url(); ?>skpi/skpi_admin/verifikasi_akhir" method="POST" id="form_verifikasi">
					<table>
	...
	<div>
		<table class="table">
			<tr>
				<td align="left"><?php echo anchor('skpi/skpi_admin/verifikasi_penulisan', 'kembali', array('class' => 'btn-uin btn btn-inverse btn btn-small')); ?></td>
			</tr>
		</table>
	</div>
