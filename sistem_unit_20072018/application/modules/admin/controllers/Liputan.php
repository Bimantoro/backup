...
class Liputan extends CI_Controller {
   ...
   function menu_json(){
        $this->datatables->select("m1.id_liputan id_liputan,m1.judul judul,m1.isi isi,concat(substring(m1.ringkasan,1, 30),'...') as ringkasan,concat(substring(m1.foto,1, 25),'...') as foto,m1.deskripsi_foto deskripsi_foto, m1.tgl_posting tgl_posting")
