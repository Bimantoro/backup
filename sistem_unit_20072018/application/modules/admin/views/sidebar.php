...
<div class="col-md-3">
	<aside class="sidebar">
		...
		<ul class="nav nav-list mb-xlg sort-source" data-sort-id="portfolio" data-option-key="filter" data-plugin-options='{"layoutMode": "fitRows", "filter": "*"}'>
			...
			<li>
				<a diklik="admin" style="cursor: pointer;">Super Admin</a>
				<ul id="admin" style="display: none;">
					...
					<li data-option-value="*"><a href="<?php echo site_url('admin/kamus')?>">Kamus</a></li>
				</ul>
			</li>
			<?php }?>
			...
			<?php }?>
			<li>
				<a diklik="blog" style="cursor: pointer;">Blog</a>
				<ul id="blog" style="display: none;">
			...
			<li>
				<a diklik="fitur" style="cursor: pointer;">Fitur Tambahan</a>
				<ul id="fitur" style="display: none;">
					...
					<li data-option-value=".medias"><a href="<?php echo site_url('admin/penelitian')?>">Penelitian</a></li>
				</ul>
			</li>
			<!-- <li data-option-value=".websites"><a href="<?php echo site_url('admin/berita')?>">Berita</a></li>
			<li data-option-value=".medias"><a href="<?php echo site_url('admin/pengumuman')?>">Pengumuman</a></li>
		...
		<script>
			$(document).ready(function(){
				$("a").click(function(){
					var a = this.getAttribute("diklik");
					$("#"+a).toggle();
				});
			});
		</script>
