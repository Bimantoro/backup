...
<html>
	<head>
		...
		<title>Small Slider | Porto - Responsive HTML5 Template 4.6.0</title>	
					...
					<div class="header-top header-top-tertiary header-top-style-3">
						<div class="container">
							...
							<p class="pull-right text-color-light">
								<span class="mr-xs"><i class="icon-call-end icons mr-xs"></i> (123) 456-789</span><span class="hidden-xs"></span>
							</p>
						</div>
					</div>
							...
							<div class="header-column">
								<div class="header-logo">
									<a href="<?php echo base_url()?>">
										<img alt="Porto2"  height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?php echo base_url('asset/images/logo-uin.png')?>">
									</a>
								</div>
							</div>
							<div class="header-column">
														...
														<ul class="dropdown-menu">
															...
															<li class="dropdown-submenu">
																...
																<ul class="dropdown-menu">
																	...
																	<li><a href="index-corporate-law-office.html" data-thumb-preview="img/previews/preview-corporate-law-office.jpg">Corporate - Law Office</a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
																<a href="#">Extra <span class="tip">new</span></a>
																<ul class="dropdown-menu">
																	<li><a href="index-extra-restaurant.html" data-thumb-preview="img/previews/preview-extra-restaurant.jpg">Extra - Restaurant <span class="tip">new</span></a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
																<a href="#">One Page</a>
