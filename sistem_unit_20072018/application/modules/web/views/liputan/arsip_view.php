		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="post-content">
					<h4 class="mb-none"><a href="<?php echo site_url($lang.'/liputan/detail/'.$d->id_liputan.'/'.url_title(strtolower($d->judul)))?>"><?php echo $d->judul?></a></h4>
					<div class="post-meta">
			...
			<div class="col-md-12">
				<div class="post-meta pull-right">
					<a href="<?php echo site_url($lang.'/liputan/detail/'.$d->id_liputan.'/'.url_title(strtolower($d->judul))) ?>" class="read-more"> <?php echo ucfirst(dict('selengkapnya',$lang))?> <i class="fa fa-angle-right"></i></a>
				</div>
			</div>
		</div>
