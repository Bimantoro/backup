<div  class="article-content">
	...
	<div class="mt-lg">
		<div class="col-md-6">
			<h4><?php echo ucwords(dict('Liputan Terkait', $lang)) ?></h4>
			<ul class="list list-icons list-icons-sm">
			<?php foreach($rec as $r):?>
				<li><a href="<?php echo site_url($lang.'/liputan/detail/'.$r->id_liputan.'/'.url_title(strtolower($r->judul))) ?>"><i class="fa fa-caret-right"></i> <?php echo $r->judul ?></a>
		...
		<div class="col-md-6">
			<h4><?php echo ucwords(dict('Liputan Terpopuler', $lang)) ?></h4>
			<ul class="list list-icons list-icons-sm">
			<?php
			foreach($pop as $r){?>
				<li><a href="<?php echo site_url($lang.'/liputan/detail/'.$r->id_liputan.'/'.url_title(strtolower($r->judul))) ?>"><i class="fa fa-caret-right"></i><?php echo $r->judul ?></a>
