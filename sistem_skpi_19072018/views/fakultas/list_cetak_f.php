...
<body>
	<div>
		<form class="form-inline" action="<?php echo base_url(); ?>skpi/skpi_fakultas/cetak_skpi_mhs" method="POST">
		...
		<table class="table table-bordered">
			...
			foreach ($mhs as $key) { ?>
				<tr style="padding: 0px;">
					<form action="<?php echo base_url(); ?>skpi/skpi_fakultas/cetak_skpi" method="POST" target='_blank'>
