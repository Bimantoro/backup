...
<body>
	...
	<div>
		...
		<form action="<?php echo base_url(); ?>skpi/skpi_admin/verifikasi_data_cp" method="POST">
		...
		<table class="table">
			<tr>
				<td align="left"><?php echo anchor('skpi/skpi_admin/verifikasi_data_mhs/0', 'Kembali', array('class' => 'btn-uin btn btn-inverse btn btn-small')); ?></td>
				<td align="right"><?php echo anchor('skpi/skpi_admin/verifikasi_data_prestasi/', 'Selanjutnya', array('class' => 'btn-uin btn btn-inverse btn btn-small')); ?></td>
			</tr>
		</table>
	</div>
</body>
