<?php error_reporting(E_ALL);
 ...
 <head>
 	<title><?php echo $header['IDN']; ?></title>
 </head>
<style type="text/css">
...
<!-- <div style="position:absolute; z-index:0; background:white; display:block; min-height:50%; min-width:50%; color:yellow;">
	<p style="color:lightgrey; font-size:120px; transform:rotate(300deg); -webkit-transform:rotate(300deg);">Draft Surat Ket. Pendamping Ijazah</p>
</div>
-->
...
<?php if(isset($capaian[1]) && $capaian[3]==1){ ?>
	<table style="padding-top: 5px"><tr><td></td></tr></table>
	<?php if(strlen($nomerurut)<=1){$nomertampil = '0'.$nomerurut; }else{$nomertampil = $nomerurut;} ?>
	<table cellpadding="0" cellspacing="0">
...
<?php for($i=0; $i < count($kegiatan[1]); $i++) { ?>
			...
			<table style="border: 0.1px solid #3a3a3a; width: 100%;" cellpadding="5" width="100%;">
				...
				<?php }else{ ?>
					<tr>
						<td style="border: 0.1px solid #3a3a3a; width: 6%;"><p style="font-size: 9px;">1.</p></td>
						<td style="border: 0.1px solid #3a3a3a; width: 47%;"><p style="font-size: 9px; text-align: center;">-</p></td>
						<td style="border: 0.1px solid #3a3a3a; width: 47%;"><p style="font-size: 9px; text-align: center;"><i>-</i></p></td>
					</tr>
				<?php } ?>
			</table>
			<table style="padding-top: 5px"><tr><td></td></tr></table>
