...
class MYPDF extends TCPDF {
	...
	public function Footer() {
		...
		// Page number
		$htmlbody = "page ".$this->getAliasNumPage()." of ".$this->getAliasNbPages()." ------------------------------------------------------------------------------"
						. "Danang Aji Bimantoro";
		//$this->MultiCell(0, 10, 'Page '.$this->getAliasNumPage().' of '.$this->getAliasNbPages()."\n"."Danang Aji Bimantoro", 0, false, 'C', 0, '', 0, false, 'T', 'M');
		// $this->MultiCell(0, 10, $htmlbody."\n" , 0, 'C', 0, '', 0, false, 'T', 'M');
