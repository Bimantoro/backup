<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/berita/add_berita')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_berita","bSortable":false },
			{ "mDataProp": "judul"},
			{ "mDataProp": "ringkasan"},
			{ "mDataProp": "foto"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_berita'];  
		var url_edit = "<?php echo site_url('admin/berita/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/berita/delete')?>/"+id;
