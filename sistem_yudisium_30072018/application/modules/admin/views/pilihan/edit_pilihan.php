...
<form class="form-horizontal form-bordered" method="post" action="" enctype='multipart/form-data'>
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<select class="form-control" name="kelas" id="kelas" style="pointer-events: none;" readonly>
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<input type="number" min=1 max=2 class="form-control" name="pilihan" id="pilihan" required value="<?php echo $pilihan['pilihan']; ?>" style="pointer-events: none;" readonly>
		</div>
	</div>
