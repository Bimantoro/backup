			...
			success : function(result){
				...
				if(result != '0'){
					...
					$.each(u, function(idx, val){	
						...
						row += "<td>Tahun : "+val.tahun+"<br>Kode Jalur : "+val.kode_jalur+"<br>Gelombang : "+val.kode_gelombang+"<br>Kelas : "+val.kode_kelas+"</td>";
						row += "<td align='center'>"+val.pilihan+"</td>";
						row += "<td align='center'>"+val.tgl_mulai+"</td>";
						row += "<td align='center'>"+val.tgl_selesai+"</td>";
						row += "<td>NO : "+val.no_yudisium+"<br>Ketua : "+val.ketua_yudisium+"<br>Tanggal : "+val.tgl_yudisium+"<br>Status : <b>"+val.status+"</b></td>";
						row += "<td class='center'>";
