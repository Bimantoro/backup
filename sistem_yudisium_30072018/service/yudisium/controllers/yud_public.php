...
class Yud_public extends CI_Controller {
	...
	function in_cfg_pilihan($format = 'json'){
		$api_search = $this->input->post('api_search');
		$q 			= $this->mdl_00->in_cfg_pilihan($api_search[0], $api_search[1], $api_search[2], $api_search[3], $api_search[4], $api_search[5], $api_search[6], $api_search[7], $api_search[8], $api_search[9]);
	...
	function up_cfg_pilihan($format = 'json'){
		$api_search = $this->input->post('api_search');
		$q = $this->mdl_00->up_cfg_pilihan($api_search[0], $api_search[1], $api_search[2], $api_search[3], $api_search[4], $api_search[5], $api_search[6], $api_search[7], $api_search[8], $api_search[9]);
		$this->sia_api_lib_format->output($q, $format);
	...
	function get_cfg_pilihan($format = 'json'){
		$api_search = $this->input->post('api_search');
		$q = $this->mdl_00->get_cfg_pilihan($api_search[0], $api_search[1], $api_search[2], $api_search[3], $api_search[4]);
		$this->sia_api_lib_format->output($q, $format);
	...
	function up_status_diterima_prodi($format = 'json'){
		$api_search = $this->input->post('api_search');
		$q 			= $this->mdl_00->up_status_diterima_prodi($api_search[0], $api_search[1], $api_search[2]);
