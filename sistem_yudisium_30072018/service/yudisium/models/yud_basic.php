...
class Yud_basic extends CI_Model {
	...
	function up_status_diterima_prodi($kode_prodi, $pilihan, $status){
		$q1 = $this->yud->query("UPDATE tb_yudisium SET status = '$status' WHERE kode_prodi = '$kode_prodi' AND $pilihan = '$pilihan'");
		return $q1;
	}
}
