<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/agenda/add_agenda')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_agenda","bSortable":false },
			{ "mDataProp": "nama_agenda","bSortable":true },
			{ "mDataProp": "deskripsi"},
			{ "mDataProp": "tempat"},
			{ "mDataProp": "tgl_mulai"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_agenda'];  
		var url_edit = "<?php echo site_url('admin/agenda/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/agenda/delete')?>/"+id;
