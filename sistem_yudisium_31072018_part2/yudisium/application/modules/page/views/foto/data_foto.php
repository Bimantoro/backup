<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/foto/add_foto/'.$id_album)?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_foto","bSortable":false },
			{ "mDataProp": "judul"},
			{ "mDataProp": "nama_file"},
		...
		function getAction(oObj){
			var id = oObj.aData['id_foto'];
			var id_album = oObj.aData['id_album'];  
			var url_edit = "<?php echo site_url('admin/foto/edit')?>/"+id;
			var url_delete = "<?php echo site_url('admin/foto/delete')?>/"+id_album+"/"+id;
			...
			return "<a href='"+url_delete+"' class='delete btn btn-sm btn-danger btn-icon pr-none' title='Hapus'><i class='fa fa-trash'></i></a>";
		}
