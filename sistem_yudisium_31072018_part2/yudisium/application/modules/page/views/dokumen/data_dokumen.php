<?php 
	...
	<?php  endif;?>
	<?php if (!$status) { $this->load->view('admin/dokumen/panduan'); } ?>
<a href="<?php echo site_url('admin/dokumen/add_dokumen')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_dokumen","bSortable":false },
	...
	function getAction(oObj){
		var id = oObj.aData['id_dokumen'];  
		var url_edit = "<?php echo site_url('admin/dokumen/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/dokumen/delete')?>/"+id;
