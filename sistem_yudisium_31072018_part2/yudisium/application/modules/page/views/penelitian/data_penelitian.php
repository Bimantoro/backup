...
<?php if (!$status) { $this->load->view('admin/penelitian/panduan'); } ?>
<a href="<?php echo site_url('admin/penelitian/add_penelitian')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_penelitian","bSortable":false },
			{ "mDataProp": "judul_penelitian"},
			{ "mDataProp": "jenis_penelitian"},
			{ "mDataProp": "tahun"},
			{ "mDataProp": "url"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_penelitian'];  
		var url_edit = "<?php echo site_url('admin/penelitian/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/penelitian/delete')?>/"+id;
