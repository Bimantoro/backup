<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/user/add_user')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	...
	function getAction(oObj){
		var id = oObj.aData['username'];  
		var url_edit = "<?php echo site_url('admin/user/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/user/delete')?>/"+id;
