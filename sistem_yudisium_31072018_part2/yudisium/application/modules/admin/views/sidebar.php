<div class="col-md-3">
	<aside class="sidebar">
		...
		<ul class="nav nav-list mb-xlg sort-source" data-sort-id="portfolio" data-option-key="filter" data-plugin-options='{"layoutMode": "fitRows", "filter": "*"}'>
			...
			<li data-option-value="*"><a href="<?php echo site_url('admin/data_peserta')?>">Data Peserta</a></li>
			<li data-option-value="*"><a href="<?php echo site_url('admin/rekap_nilai')?>">Rekap Nilai Ujian</a></li>
