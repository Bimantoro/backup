				...
				<div class="header-body">
					...
					<div class="header-container container">
						<div class="header-row">
							...
							<div class="header-column" style="vertical-align: middle;">
								<div class="header-row " style="vertical-align: middle;">
									<div class="heading heading-middle-border-reverse">
										<h3 class="mt-lg mb-md" style="vertical-align: middle; color: white;">UIN SUNAN KALIJAGA</h3>
									</div>	
								</div>
								<div class="header-row">
