...
class Yudisium extends CI_Controller {
   ...
   public function index($uri=0){
		...
		$data['json_url_peserta2'] =site_url('admin/yudisium/ajax_get_data_peserta');
		$data['json_url_prodi'] =site_url('admin/yudisium/ajax_get_prodi2');
		$data['json_url_kelas'] =site_url('admin/yudisium/ajax_get_kelas');
		...
		$data['json_url_diterima_prodi'] =site_url('admin/yudisium/ajax_sv_diterima_prodi');
		$data['json_url_detail_nilai'] =site_url('admin/yudisium/ajax_get_nilai_peserta');
   ...
   function ajax_sv_diterima_prodi(){
   		...
   		$data = $this->s00_lib_api->get_api_json(
			URL_API_YUD.'yud_public/up_status_diterima_prodi',
		 	'POST',
		 	array(
		 		'api_search' => array($prodi, $pilihan, $status, $kelas)
		 	));
    ...
    function ajax_get_data_peserta(){
		...
		$data = $this->s00_lib_api->get_api_json(
			URL_API_YUD.'yud_public/get_data_yudisium2',
		 	'POST',
		 	array(
		 		'api_search' => array($prodi, $tahun, $gelombang, $jalur, $pilihan, $kelas)
		 	));
