...
<div id="ctn-diterima" hidden>
	<div class="row" style="margin-bottom: 10px;" id="btn-cetak" hidden>
		<label class="col-md-3 control-label" for="jalur"></label>
		<div class="col-md-6"></div>
		<div class="col-md-3" align="right"><a id="btn-cetak-diterima" href="" target="_blank"><button class="btn btn-small btn-success">Cetak SK Yudisium</button></a></div>
	</div>
	...
	function fill_data(){
		...
		$.ajax({
			...
			success : function(result){
				...
				if(result != '0'){
					$('#btn-cetak').show();
					var link = '<?php echo base_url() ?>'+'admin/peserta_diterima/cetak_sk_yudisium/'+tahun+'/'+gelombang+'/'+jalur+'/'+prodi;
					$('#btn-cetak-diterima').attr('href', link);
