<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/slide/add_slide')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_slide","bSortable":false },
			{ "mDataProp": "picture"},
			{ "mDataProp": "background"},
			{ "mDataProp": "tgl_mulai"},
			{ "mDataProp": "tgl_selesai"},
			{ "mDataProp": "url"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_slide'];  
		var url_edit = "<?php echo site_url('admin/slide/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/slide/delete')?>/"+id;
