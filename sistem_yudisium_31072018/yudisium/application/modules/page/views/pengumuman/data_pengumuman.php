<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/pengumuman/add_pengumuman')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
<table class="datatable table table-striped table-bordered" id="datatable">
<thead>
  <tr>
	<th width="5%">No</th>
	<th width="20%">Nama Pengumuman</th>
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_pengumuman","bSortable":false },
			{ "mDataProp": "nama_pengumuman"},
			{ "mDataProp": "nama_file"},
			{ "mDataProp": "url"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_pengumuman'];  
		var url_edit = "<?php echo site_url('admin/pengumuman/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/pengumuman/delete')?>/"+id;
