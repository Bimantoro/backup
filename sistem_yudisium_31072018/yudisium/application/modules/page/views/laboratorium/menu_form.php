<form class="form-horizontal form-bordered" method="post" action="" enctype='multipart/form-data'>
	<div class="form-group">
		<label class="col-md-3" for="title">Nama Laboratorium</label>
		<div class="col-md-6">
			<input type="text" class="form-control" name="nama_lab" id="nama_lab">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label class="col-md-3" for="bahasa">Foto Laboratorium</label>
		<div class="col-md-6">
