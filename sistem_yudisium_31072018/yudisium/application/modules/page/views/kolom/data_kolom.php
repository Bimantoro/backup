<?php 
	...
	<?php  endif;?>
<a href="<?php echo site_url('admin/kolom/add_kolom')?>" class="btn btn-default add"> <i class="fa fa-plus"></i> Tambah</a>		
...
<script type="text/javascript" charset="utf-8">
	 ...
	 $('#datatable').dataTable
		({
			...
			'aoColumns': [ 			
			{ "mDataProp": "id_kolom","bSortable":false },
			{ "mDataProp": "judul"},
			{ "mDataProp": "ringkasan"},
	...
	function getAction(oObj){
		var id = oObj.aData['id_kolom'];  
		var url_edit = "<?php echo site_url('admin/kolom/edit')?>/"+id;
		var url_delete = "<?php echo site_url('admin/kolom/delete')?>/"+id;
