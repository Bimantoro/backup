...
<form class="form-horizontal form-bordered" method="post" action="" enctype='multipart/form-data'>
	<div class="form-group">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="kode_unit" id="kode_unit" required readonly value="<?php echo $usr->username; ?>">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-6">
			...
			<select class="form-control" name="nama_unit" id="nama_unit" required>
				<?php if($units){
					foreach ($units as $u) {
